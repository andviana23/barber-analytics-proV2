...
func ToContaReceberResponse(conta *entity.ContaReceber) dto.ContaReceberResponse {
	...
	return dto.ContaReceberResponse{
		...
		Valor:           conta.Valor.String(),
		ValorPago:       conta.ValorPago.String(),
		ValorAberto:     conta.ValorAberto.String(),
		DataVencimento:  conta.DataVencimento.Format("2006-01-02"),
...
func ToFluxoCaixaDiarioResponse(fluxo *entity.FluxoCaixaDiario) dto.FluxoCaixaDiarioResponse {
	return dto.FluxoCaixaDiarioResponse{
		...
		SaldoInicial:        fluxo.SaldoInicial.String(),
		EntradasConfirmadas: fluxo.EntradasConfirmadas.String(),
		EntradasPrevistas:   fluxo.EntradasPrevistas.String(),
		SaidasPagas:         fluxo.SaidasPagas.String(),
		SaidasPrevistas:     fluxo.SaidasPrevistas.String(),
		SaldoFinal:          fluxo.SaldoFinal.String(),
...
func ToCompensacaoBancariaResponse(comp *entity.CompensacaoBancaria) dto.CompensacaoBancariaResponse {
	...
	return dto.CompensacaoBancariaResponse{
		...
		ValorBruto:      comp.ValorBruto.String(),
		TaxaPercentual:  comp.TaxaPercentual.String(),
		TaxaFixa:        comp.TaxaFixa.String(),
		ValorLiquido:    comp.ValorLiquido.String(),
...
func ToDREMensalResponse(dre *entity.DREMensal) dto.DREMensalResponse {
	return dto.DREMensalResponse{
		...
		ReceitaServicos:      dre.ReceitaServicos.String(),
		ReceitaProdutos:      dre.ReceitaProdutos.String(),
		ReceitaPlanos:        dre.ReceitaPlanos.String(),
		ReceitaTotal:         dre.ReceitaTotal.String(),
		CustoComissoes:       dre.CustoComissoes.String(),
		CustoInsumos:         dre.CustoInsumos.String(),
		CustoVariavelTotal:   dre.CustoVariavelTotal.String(),
		DespesaFixa:          dre.DespesaFixa.String(),
		DespesaVariavel:      dre.DespesaVariavel.String(),
		DespesaTotal:         dre.DespesaTotal.String(),
		ResultadoBruto:       dre.ResultadoBruto.String(),
		ResultadoOperacional: dre.ResultadoOperacional.String(),
		MargemBruta:          dre.MargemBruta.String(),
		MargemOperacional:    dre.MargemOperacional.String(),
		LucroLiquido:         dre.LucroLiquido.String(),
