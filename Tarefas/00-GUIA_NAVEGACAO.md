...
| **Backend (Go)**       | 🟡 Parcial  | ~40% (falta 19 entidades + repos + use cases) |
| **Frontend (Next.js)** | 🟡 Parcial  | ~30% (falta services + hooks + páginas)       |
| **Bloqueios de Base**  | 🔴 CRÍTICO  | 0% - **DEVE SER FEITO PRIMEIRO**              |
...
└──────────────────────┘
           ↓
┌──────────────────────┐
│   ETAPA 1 (BASE)    │  Status: 🔴 BLOQUEADOR - PRIORIDADE MÁXIMA
├──────────────────────┤  Tempo: ~23 dias
│ 01-BLOQUEIOS-BASE    │  📂 Tarefas/01-BLOQUEIOS-BASE/
│                      │  📂 Tarefas/CONCLUIR/
│ Sub-etapas:          │
│ ├─ Domain (19 ent)   │  ⏱️  3-4 dias
│ ├─ Ports/Interfaces  │  ⏱️  2 dias
│ ├─ Repositories      │  ⏱️  5 dias
│ ├─ Use Cases         │  ⏱️  4 dias
│ ├─ HTTP Handlers     │  ⏱️  3 dias
│ ├─ Cron Jobs         │  ⏱️  2 dias
│ ├─ Frontend Services │  ⏱️  2 dias
│ └─ Frontend Hooks    │  ⏱️  2 dias
└──────────────────────┘
           ↓
┌──────────────────────┐
│   ETAPA 2 (OPS)     │  Status: ⏳ Aguardando Etapa 1
├──────────────────────┤  Tempo: ~1 semana
...
│                                                               │
│  Podem ser executadas EM PARALELO após Etapa 1 concluída     │
└──────────────────────────────────────────────────────────────┘
           ↓
┌──────────────────────┐    ┌──────────────────────┐
...
│                      │    │                      │
│ 6 sub-módulos:       │    │ 6 sub-módulos:       │
│ 1. Contas a Pagar    │    │ 1. Entrada           │
│ 2. Contas a Receber  │    │ 2. Saída             │
│ 3. Fluxo Compensado  │    │ 3. Consumo Auto      │
│ 4. Comissões Auto    │    │ 4. Inventário        │
│ 5. DRE Completo      │    │ 5. Estoque Mínimo    │
│ 6. Dashboard         │    │ 6. Curva ABC         │
└──────────────────────┘    └──────────────────────┘
