...
- [ ] **Containerização**
  - [ ] Dockerfile multi-stage para Go
    - [ ] Build stage (com cache de deps)
    - [ ] Run stage (imagem mínima)
    - [ ] Variáveis de ambiente documentadas
  - [ ] docker-compose.yml
    - [ ] Serviço `api` (Go)
    - [ ] Serviço `db` (PostgreSQL 14)
    - [ ] Volumes para persistência
    - [ ] Network isolada
  - [ ] .dockerignore com padrões Go
...
- [ ] **CI/CD com GitHub Actions**
  - [ ] Workflow `.github/workflows/ci.yml`
    ...
    - [ ] Steps:
      ...
      - [ ] Tests com coverage
      - [ ] Build Docker image
      - [ ] Push para registry (ou skip para dev)
  - [ ] Workflow `.github/workflows/deploy.yml`
    - [ ] Trigger: push em `main`
    - [ ] Deploy via SSH/rsync para VPS
    - [ ] Restart serviço via systemd
...
- [ ] **Logs & Monitoring Base**
  ...
  - [ ] Sistema de coleta:
    ...
    - [ ] Docker logs para containerizado
  - [ ] Scripts úteis:
...
- ✅ Backend containerizado rodando localmente
